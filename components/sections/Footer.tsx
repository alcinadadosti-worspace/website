  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute right-0 top-0 h-96 w-96 rounded-full bg-pink-600/10 blur-3xl" />
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-purple-600 transition-transform hover:scale-110"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
          ...
          <p className="mt-2">
            Desenvolvido com{" "}
            <span className="text-pink-400">♥</span> em Alagoas
          </p>
        </div>
      </div>
    </footer>
