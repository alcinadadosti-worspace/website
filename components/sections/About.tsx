  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-0 top-0 h-96 w-96 rounded-full bg-sage-100/50 blur-3xl" />
        <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-champagne-100/50 blur-3xl" />
      </div>
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            ...
            <motion.h2
              ...
              className="mt-6 text-4xl font-bold tracking-tight text-neutral-800 sm:text-5xl lg:text-6xl"
            >
              Beleza com{" "}
            ...
            <motion.div variants={itemVariants} className="mt-8">
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="rounded-2xl border border-champagne-200 bg-white p-6 shadow-sm">
                  <div className="text-4xl font-bold text-sage-500">15+</div>
                  <div className="mt-2 text-sm font-semibold text-neutral-800">
                    Anos de experiência
                  </div>
                </div>
                <div className="rounded-2xl border border-champagne-200 bg-white p-6 shadow-sm">
                  <div className="text-4xl font-bold text-sage-500">7</div>
                  <div className="mt-2 text-sm font-semibold text-neutral-800">
                    Marcas de prestígio
                  </div>
                </div>
          ...
          >
            <div className="relative h-[500px] w-full overflow-hidden rounded-3xl bg-gradient-to-br from-champagne-100 to-sage-100 shadow-2xl">
              {/* Placeholder para imagem da equipe ou loja */}
              <div className="flex h-full items-center justify-center">
                <div className="text-center text-neutral-600">
                  <svg
                    className="mx-auto h-24 w-24 text-sage-400"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-champagne-100">
                  <svg
